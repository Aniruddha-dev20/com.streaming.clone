...
import com.streaming.clone.service.FileUploadService;
import com.streaming.clone.utils.FileHandlerUtil;
...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    @Value("${file.uplaod.video-dir:uploads/videos}")
    private String videoDir;

    @Value("${file.uplaod.image-dir:uploads/images}")
    ...
    public void init(){
        ...
        try {
            ...
            throw new RuntimeException("Could not create the library where uploaded files will be stored.",ex);
        }
    }
    ...
    private String storeFile(MultipartFile file, Path storageLocation) {
        String fileExtention = FileHandlerUtil.extractFileExtension(file.getOriginalFilename());
    ...
    private ResponseEntity<Resource> buildPartialVideoResponse(Path filePath, String rangeHeader, String contentType, String filename, long fileLength)
            throws Exception {
